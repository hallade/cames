...
<title><?php echo $Ligne_Element['Titre']?></title>
...
<br/>
<h2 class="TitleEvent"   align="left"  style=""><?php echo $Ligne_Element['Titre'] ?> </h2>
 
<p class="DatePub"> 
  Publié le : <?php echo Transform( $Ligne_Element['Mise en ligne le'] );?>  

   

</p>

<img src="images/<?php echo $Ligne_Element['Photo'];?>" class="ImgEvent"  width=80% height=322px/>
<p class="DétailEvent">  <?php echo $Ligne_Element['Détail'];?> </p>

<?php include ('inc.Page-Sec-Gen-PJ.php');?>
...
<!--Bloc Bleu Debut-->             
<div id="BlocSecGeneral"  align="left">           
         
<h2 class="TitleBxBlue" style="color:#fff;" align="center"> SECRETARIAT GENERAL  </h2>
           <UL  class="UL_Block" >
               <?php include('inc.ExtractTitleSecGen.php');?>
