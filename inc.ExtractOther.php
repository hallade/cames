...
rubrique,
periode ,
statut  WHERE information.codsousrubrique = sousrubrique.codsousrubrique AND sousrubrique.codrubrique = rubrique.codrubrique AND information.per_codperiode2 = periode.codperiode AND information.codstatut = statut.codstatut AND libstatut='Nouveau' AND rubrique.librubrique = 'ACCUEIL' AND sousrubrique.libsousrubrique = 'EVENEMENTS' AND codinformation != '".$var."' order by Du asc ";
...
<span class="TitleInfo" style="color:#000000;padding-left:10px;padding-top:8px;"> DU '.Transform($LigneEvtDif['DU']).' AU '.Transform($LigneEvtDif['AU']).'</span>
        ...
        <img src="images/'.$LigneEvtDif['Vignette'].'" width="90px" style="margin-left:8px;margin-top:5px;float:left;padding:2px;border:solid 1px #fff;">
