...
<title>LISTE DES PAYS MEMBRES</title>
...
<br/>
<h2 class="TitleEvent"   align="center"  style="color:#cf3a24;">LISTE DES PAYS MEMBRES  </h2>
...
">
  <TR  style="background-color: #2d5fb2;"> 
     <TD  align="center" class="Title3">Pays</TD>
     <TD align="center" class="Title3"> Site Web </TD> 
     <TD align="center" class="Title3"> Date d'adhésion </TD> 

  </TR>
 <?php 
include ('inc.PaysMembres.php');
  ?>
 </TABLE>
