...
while ( ( $Ligne = $sqlTitle -> fetch_array() )  )
	  ...
	  $Title_ID=$Ligne['ID'];            
	    ...
	    echo '<LI> <a class="Links_Blocs" href="Page-sec-gen.php?passage='.$Title_ID.'">'.$Title.'</a></LI>';
