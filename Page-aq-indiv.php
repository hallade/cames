...
<h2 class="TitleEvent"   align="center"  style="color:#cf3a24;"><?php echo $Ligne_Element['Titre']?>  </h2>
 


<p class="DétailEvent" style="" align="center">  <?php echo $Ligne_Element['Détail'];?> </p>
