...
<?php include('inc.cid.php');?>
<br/>
<h2 class="TitleEvent"   align="center"  style="color:#cf3a24;"><?php echo $Ligne['Titre']?>  </h2>
 
 
<img src="<?php echo $Ligne['Vignette']?>" width=25% class="ImgCID" >


<img src="<?php echo $Ligne['Photo']?>" width=25% class="ImgCID" style="float:right; margin-right:10px;">

<p class="DétailEvent" style="float:right">  <?php echo $Ligne['Détail'];?> </p>


<div style="clear:both;"></div>


<?php include ('inc.CID-PJ.php'); ?>
...
<!--Espace numerique Debut-->
<div class="BlocThese Arrondi3 Ombre">
<h2 class="TitleCDIDr" style="text-align:center;background-color:#7da03a;color:#fff;">Espace numérique  </h2>

<ul class="UL_CID" style="text-align:left">
  <li>
	<span style="padding-left:10px;"><img src="images/dc85rjzMi.png" width=15px style="vertical-align:middle;"></span>
	<span style="padding-left:10px;"><a href="http://greenstone.lecames.org/cgi-bin/library" target="_blank">Bibliothèque numérique</a></span>
  </li>
  <li>
	<span style="padding-left:10px;"><img src="images/dc85rjzMi.png" width=15px style="vertical-align:middle;"></span>
	<span style="padding-left:10px;"><a href="http://publication.lecames.org" target="_blank">Portail des Revues Africaines </a></span>
  </li>
  

</ul>
</div>
<!--Espace numerique Fin-->
...
<h2 class="TitleCDIDr" style="text-align:center;background-color:#7030a0;color:#fff;">Espace Téléchargements  </h2>
<ul class="UL_CID" style="text-align:left">
  <li><span style="padding-left:10px;"><img src="images/dc85rjzMi.png" width=15px style="vertical-align:middle;"></span>
       <span style="padding-left:10px;"><a href="download/cid/Inscription_biblio.pdf" target="_blank"">Inscription à la bibliothèque</a></span>
  </li>
  <li><span style="padding-left:10px;"><img src="images/dc85rjzMi.png" width=15px style="vertical-align:middle;"></span>
       <span style="padding-left:10px;"><a href="download/cid/Inscription_internet.pdf" target="_blank"">Inscription à internet</a></span>
       </li>
  <li><span style="padding-left:10px;"><img src="images/dc85rjzMi.png" width=15px style="vertical-align:middle;"></span>
      <span style="padding-left:10px;">
         <a href="download/cid/Inscription_revue.pdf" target="_blank">Inscription aux revues</a>
       </span>
       </li>
