...
<title><?php echo $LigneEvt_Indiv['Titre']?></title>
...
<br/>
<h2 class="TitleEvent"   align="left"  style=""><?php echo $LigneEvt_Indiv['Titre'] ?> </h2>
 
<p class="DatePub"> 

 Publié le : <?php echo Transform( $LigneEvt_Indiv['Mise en ligne le'] );?>  | 

 <span style="padding:1px 8px 1px 8px;background-color:#7030a0;font-size:12px;color:#fff;" class="Arrondi">Evénements</span> 

</p>

<img src="images/<?php echo $LigneEvt_Indiv['Photo'];?>" class="ImgEvent"  width=80% height=322px/>
<p class="DétailEvent">  <?php echo $LigneEvt_Indiv['Détail'];?> </p>



<?php include ('inc.Events-Indiv-PJ.php'); ?>
</div>
<!------------------->
<!--Bloc Left Fin  -->
<!------------------->
...
<!--Bloc Vert Debut-->             
<div id="BlocEvntAVenir"  align="center">                     
<h2 class="TitleBxVert" style="color:#fff;">TOUS LES EVENEMENTS</h2>
<?php include ('inc.ExtractOther.php')?>
