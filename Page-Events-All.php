...
<title>Actualité du Secretariat Général</title>
...
<!--Debut 1-->
<div  style="background-color:#fff;width:100%;height:auto;margin-top:10px;padding-top:0px;">
...
<!--Bloc Right Debut-->
<div class="RightBlocEvent" style="float:right;" align="center">
...
<?php include ('inc.ExtractOther2.php')?>
