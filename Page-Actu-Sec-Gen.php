...
<title><?php echo $LigneAct_IndivSG['Titre']?></title>
...
<br/>
<h2 class="TitleEvent"   align="left"  style=""><?php echo $LigneAct_IndivSG['Titre'] ?> </h2>
 
<p class="DatePub"> 
  Publié le : <?php echo Transform( $LigneAct_IndivSG['Mise en ligne le'] );?>  
  |   
 <span style="padding:1px 8px 1px 8px;background-color:#fabe12;font-size:12px;color:#fff;" class="Arrondi">Actualité SECRETARIAT GENERAL </span>
</p>

<img src="images/<?php echo $LigneAct_IndivSG['Photo'];?>" class="ImgEvent"  width=80% height=322px/>
<p class="DétailEvent">  <?php echo $LigneAct_IndivSG['Détail'];?> </p>




<?php include ('inc.Actu-Indiv-SG-PJ.php'); ?>
...
<!--Bloc Vert Debut-->             
<div id="BlocActuASG" style="" >                     
<h2 class="TitleBxVert" style="color:#fff;">TOUTES LES ACTUALITES</h2>
<?php include ('inc.ExtractOtherActuSG.php')?>
