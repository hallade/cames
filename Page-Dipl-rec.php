...
<FORM action="Page-Dipl-rec2.php" METHOD="POST" >
...
<TR>
  ...
  <TD>
<select name="PAYS" id="course" style="width:158px;" required>
   <option value="none"> Choisissez </option>
    <?php include('inc.List-Pays.php');?>
</select> 
  </TD>
</TR>
...
<TR  >
  ...
  <TD>
    <input type="SUBMIT" value="ENVOVER" class="  Arrondi" style="cursor:pointer;" name ="ENVOI"/>
