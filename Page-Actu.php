...
<title><?php echo $LigneAct_Indiv['Titre']?></title>
...
<br/>
<h2 class="TitleEvent"   align="left"  style=""><?php echo $LigneAct_Indiv['Titre'] ?> </h2>
 
<p class="DatePub"> 
  Publié le : <?php echo Transform( $LigneAct_Indiv['Mise en ligne le'] );?>  
  |
   
 <span style="padding:1px 8px 1px 8px;background-color:#900;font-size:12px;color:#fff;" class="Arrondi">Actualité du CAMES</span>
</p>

<img src="images/<?php echo $LigneAct_Indiv['Photo'];?>" class="ImgEvent"  width=80% height=322px/>
<p class="DétailEvent">  <?php echo $LigneAct_Indiv['Détail'];?> </p>


<?php include ('inc.Actu-Indiv-PJ.php'); ?>
</div>
<!------------------->
<!--Bloc Left Fin  -->
<!------------------->
...
<!--Bloc Vert Debut-->             
<div id="BlocActuAutre"  align="center">                     
<h2 class="TitleBxVert" style="color:#fff;">TOUTES LES ACTUALITES</h2>
<?php include ('inc.ExtractOtherActu.php')?>
